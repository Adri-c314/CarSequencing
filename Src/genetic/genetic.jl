...
# @return ::String : le string pour le txtoutput
# @return ::Array{Array{Array{Array{Int,1},1},1},1} : La population
function geneticEnfants!(datas::NTuple{4,DataFrame}, NDTree::Sommet, nbSol::Int, temps_init::Float64 = 120., temps_phase1::Float64 = 300., temps_phaseAutres::Float64 = 300., temps_popNonElite::Float64 = 30., temps_global::Float64 = 300., temps_mutation::Float64 = 0.1, mutation2::Bool=true, cota::Int=0, verbose::Bool=true, txtoutput::Bool=true)
    if verbose
        n=0
        st_output = string("Execution : [")
    end
