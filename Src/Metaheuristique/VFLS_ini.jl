...
function VFLS_ini(datas::NTuple{4,DataFrame}, temps_max::Float64 = 1.0, verbose::Bool=true, txtoutput::Bool=true)
    ...
    @time for Phase in 1:3
        ...
        #for i in 1:100
            ...
            effect = global_mouvement_2!(f_mouv, sequence_meilleure, k, l, ratio_option, tab_violation, Hprio, obj, pbl, f_rand)
    ...
    for car in sequence_meilleure
        println(car[szcar-1]-car[szcar-2])
    end
    return a, b, txt
end
