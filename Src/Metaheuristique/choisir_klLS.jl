...
## du coup non # @return k::UInt64 : l'indice k
## du coup non # @return l::UInt64 : l'indice l
...
function choisir_klLS(sequence_courrante::Array{Array{Int64,1},1}, opt::Array{Int64,1},obj::Array{Int64,1},phase::Int)
